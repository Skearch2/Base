				...
				<div class="m-login__container">
					...
					<div class="m-login__signin">
						<div class="m-login__head">
							<h3 class="m-login__title">Set new Skearch password</h3>
						</div>
						<fieldset class="m-login__form m-form" form='login_form' name='login_fields'>
							...
							<div class="form-group m-form__group">
								<input class="form-control m-input m-login__form-input--last" id="password" name="old_password" type="password" placeholder="Old Password">
							</div>
							<div class="form-group m-form__group">
								<input class="form-control m-input m-login__form-input--last" id="password" name="new_password" type="password" placeholder="New Password">
							</div>
							<div class="form-group m-form__group">
								<input class="form-control m-input m-login__form-input--last" id="password" name="new_password2" type="password" placeholder="Confirm New Password">
							</div>
