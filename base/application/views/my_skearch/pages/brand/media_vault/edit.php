							...
							<div class="m-portlet__body">
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-7">
										...
										<?php if ($is_video) : ?>
											<video controls src="<?= site_url("base/media/vault/brand_$brand_id/$media->media") ?>" style="display:block; width:auto; height:auto; max-width:600px; max-height:600px;">
												Unable to play video, incompatible browser.
											</video>
										<?php else : ?>
											<img src="<?= site_url("base/media/vault/brand_$brand_id/$media->media") ?>" style="display:block; width:auto; height:auto; max-width:600px; max-height:600px;">
										<?php endif ?>
									</div>
								</div>
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-lg-7 col-md-9 col-sm-12">
										<textarea class="form-control" name="note" rows="5"><?= set_value('note', $media->note) ?></textarea>
									</div>
								</div>
								<div>
