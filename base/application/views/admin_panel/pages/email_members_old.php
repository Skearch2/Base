					...
					-->
							<div class="form-group m-form__group row">
								<div class="col-lg-9 m-form__group-sub">
										<input type="text" class="form-control m-input" id="example-ajax-post" name="email" placeholder="Search by Last Name">
								</div>
							</div>
                <div class="form-group m-form__group row">
                    <div class="col-lg-9 m-form__group-sub">
...
$(document).ready(function(){
  $("#example-ajax-post").keyup(function(){
    var keyword = $('#example-ajax-post').val();
  });
});
...
var options = {
		...
		//alert(keyword);
		url: "<?=site_url();?>admin/users/get_users_by_lastname/f",
