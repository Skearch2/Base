						...
						<form class="m-form m-form--state m-form--fit m-form--label-align-right" id="m_form" role="form" method="POST">
							...
							<div class="m-portlet__body">
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-7">
										<input class="form-control m-input" type="text" name="coin_name" value="<?= set_value('coin_name', $coin_name); ?>">
									</div>
								</div>
								<div class="form-group m-form__group row">
									<label for="brand" class="col-2 col-form-label">Wallet Address *</label>
									<div class="col-7">
										<input class="form-control m-input" type="text" name="wallet_address" value="<?= set_value('wallet_address', $wallet_address); ?>">
									</div>
								</div>
