			...
			<div class="m-portlet__head-tools">
				<ul class="m-portlet__nav">
					<li class="m-portlet__nav-item">
						<a href="<?= site_url("admin/brands/keywords/create/id/$brand->id"); ?>" class="btn btn-primary m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
							<span>
	...
	var DatatablesDataSourceAjaxServer = {
		init: function() {
			$("#m_table_1").DataTable({
				...
				processing: !0,
				serverSide: !1,
				ajax: "<?= site_url("admin/brands/brandlinks/get/brand/id/$brand->id"); ?>",
				columns: [{
					data: "keywords"
				}, {
					data: "url"
				...
				columnDefs: [{
						...
						render: function(a, t, e, n) {
							...
							return '<a href="<?= site_url() . "admin/brands/keywords/update/id/" ?>' + e['id'] + '" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Edit"><i class="la la-edit"></i></a>' +
