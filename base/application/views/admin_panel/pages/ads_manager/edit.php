						...
						<form class="m-form m-form--fit m-form--label-align-right" id="m_form" role="form" method="POST" enctype="multipart/form-data">
							...
							<div class="m-portlet__body">
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-7">
										<input type="hidden" name="is_active" value="0" <?= set_value('enabled', $ad->is_active) == 0 ? 'checked' : "" ?>>
										<span class="m-switch m-switch--icon-check">
											<label>
												<input type="checkbox" name="is_active" value="1" <?= set_value('enabled', $ad->is_active) == 1 ? 'checked' : "" ?>>
												<span></span>
											</label>
										</span>
									</div>
