			...
			<div class="m-pricing-table-1">
				<div class="m-pricing-table-1__items row">
					...
					<div class="m-pricing-table-1__item col-lg-3">
						...
						<div class="m-pricing-table-1__btn">
							<div class="m-dropdown m-dropdown--up m-dropdown--inline m-dropdown--align-left" m-dropdown-toggle="click" aria-expanded="true">
								...
								<div class="m-dropdown__wrapper" style="z-index: 101;position:overflow;	">
									<div class="m-dropdown__inner">
										<div class="m-dropdown__body">
											<div class="m-dropdown__content">
												<div class="m-scrollable m-scroller ps" data-flip="true" data-scrollable="true" data-height="400" style="height: 400px; overflow: hidden;">
													<ul class="m-nav">
