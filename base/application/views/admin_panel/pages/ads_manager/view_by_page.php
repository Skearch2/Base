			...
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					<span class="m-portlet__head-icon">
						<i class="fa fa-<?= ($scope == 'umbrella') ? 'umbrella' : 'th' ?> m--font-brand"></i>
					</span>
					<h3 class="m-portlet__head-text m--font-brand">
						<?= ucwords($scope) ?> : <?= ucwords($$scope) ?>
					</h3>
				</div>
			</div>
					...
					<li class="m-portlet__nav-item">
						<div class="btn-group" role="group">
							...
							<div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
								<a class="dropdown-item" href="<?= site_url(); ?>admin/ads/manager/view/<?= $scope ?>/id/<?= $scope_id ?>/banner/<?= $banner ?>/show/library">Library</a>
								<a class="dropdown-item" href="<?= site_url(); ?>admin/ads/manager/view/<?= $scope ?>/id/<?= $scope_id ?>/banner/<?= $banner ?>/show/archived">Archived</a>
							</div>
						</div>
					</li>
					<li class="m-portlet__nav-item">
						<div class="btn-group" role="group">
							...
							<div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
								<a class="dropdown-item" href="<?= site_url(); ?>admin/ads/manager/view/<?= $scope ?>/id/<?= $scope_id ?>/banner/a/show/library">Banner A</a>
								<?php if ($scope == 'field') : ?>
									<a class="dropdown-item" href="<?= site_url(); ?>admin/ads/manager/view/<?= $scope ?>/id/<?= $scope_id ?>/banner/b/show/library">Banner B</a>
								<?php endif ?>
								<?php if ($scope == 'umbrella') : ?>
									<a class="dropdown-item" href="<?= site_url(); ?>admin/ads/manager/view/<?= $scope ?>/id/<?= $scope_id ?>/banner/u/show/library">Banner U</a>
								<?php endif ?>
							</div>
						</div>
					</li>
					<li class="m-portlet__nav-item">
						<a href="<?= site_url("admin/ads/manager/create/{$scope}/id/{$scope_id}/banner/{$banner}") ?>" class="btn btn-primary m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
							<span>
		...
		var datatableArchived = {
			init: function() {
				$("#m_table_archived").DataTable({
					...
					processing: !0,
					serverSide: !1,
					ajax: "<?= site_url(); ?>admin/ads/manager/get/<?= $scope ?>/id/<?= $scope_id ?>/banner/<?= $banner ?>/archived/<?= $is_archived ?>",
					columns: [{
						data: "id"
					}, {
						data: "brand"
			...
			init: function() {
				$("#m_table_library").DataTable({
					...
					columnDefs: [{
						...
						render: function(a, t, e, n) {
							var title = e['title'].replace(/ /g, '%20');
							return '<a href="<?= site_url() . "admin/ads/manager/update/ad/id/" ?>' + e['id'] + '/<?= $scope ?>/id/<?= $scope_id ?>/banner/<?= $banner ?>" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Edit"><i class="la la-edit"></i></a>' +
						...
						targets: 7,
						render: function(a, t, e, n) {
							return '<a href="#" title="View">' + e['clicks'] + '</a>'
						}
					}, {
						targets: 8,
						render: function(a, t, e, n) {
							return '<a href="#" title="View">' + e['impressions'] + '</a>'
						}
					}, {
						targets: 9,
						render: function(a, t, e, n) {
