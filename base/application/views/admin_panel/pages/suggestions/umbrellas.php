              ...
              <div class="m-form m-form--fit m-form--label-align-right">
                <div class="m-portlet__body">
                    ...
                    <div class="m-form__content">
                      <div class="m-alert m-alert--icon alert alert-success m--show" role="alert">
                        ...
                        <div class="m-alert__text">
                          The Umbrella suggestion(s) has been updated.
                        </div>
                  ...
                  <?php elseif ($this->session->flashdata('success') === 0) : ?>
                    <div class="m-form__content">
                      <div class="m-alert m-alert--icon alert alert-danger m--show" role="alert">
                        ...
                        <div class="m-alert__text">
                          Unable to update Umbrella suggestion(s).
                        </div>
                        <div class="m-alert__close">
                          <button type="button" class="close" data-close="alert" aria-label="Close">
                          </button>
                  ...
                  <div class="form-group m-form__group row">
                    ...
                    <div class="col-7">
                      <select class="form-control m-bootstrap-select m_selectpicker" data-live-search="true" onchange="getSuggestions(this.value)" name="umbrella">
        ...
        obj['results'].forEach(r => {
          ...
          if (flag && r.id != umbrellaId) {
            ...
            $(resultsList).append(
              ...
              '<input type="hidden" name="item[' + index + '][umbrella_id]" value="' + umbrellaId + '" disabled="">' +
