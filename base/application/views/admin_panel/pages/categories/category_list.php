...
var DatatablesDataSourceAjaxServer= {
    init:function() {
        $("#m_table_1").DataTable( {
            responsive:!0, dom:'<"top"lfp>rt<"bottom"ip><"clear">', rowId: "id", order: [[ 1, 'asc' ]], searchDelay:500, lengthMenu:[[50,100,-1],[50,100,"ALL"]], processing:!0, serverSide:!1, ajax:"<?= site_url(); ?>/admin/categories/get_category_list/<?=$status;?>", columns:[{
				data: "id"
            }
            , {
                data: "title"
            ...
            ,  {
							targets:3, title:"Fields", render:function(a, t, e, n) {
