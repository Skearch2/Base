...
var DatatablesDataSourceAjaxServer= {
    ...
    init:function() {
        $("#m_table_1").DataTable( {
            responsive:!0, dom:'<"top"lfp>rt<"bottom"ip><"clear">', rowId: "id", order: [[ 1, 'asc' ]], searchDelay:500, lengthMenu:[[50,100,-1],[50,100,"ALL"]], processing:!0, serverSide:!1, ajax:"<?= site_url(); ?>/admin/categories/get_subcategory_list/<?= $categoryid; ?>/<?= $status; ?>", columns:[ {
			    data: "id"
            }
            , {
                data: "title"
            ...
            ,
            {
							targets:4, title:"Adlinks", render:function(a, t, e, n) {
...

            {
                targets:7, render:function(a, t, e, n) {
                    var s= {
                        ...
                        , 3: {
                            title: "Member", class: " m-badge--primary"
                        }
                        , 4: {
            ...
            , {
                targets:5, render:function(a, t, e, n) {
                    var s= {
                        0: {
                            title: "No", state: "danger"
                        }
                        , 1: {
                            title: "Yes", state: "accent"
                        }
                    }
                    ;
