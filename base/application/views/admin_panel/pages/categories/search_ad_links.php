...
var DatatablesDataSourceAjaxServer= {
    init:function() {
        $("#m_table_1").DataTable( {
            responsive:!0, bFilter: false, rowId: "id", order: [[ 0, 'asc' ]], searchDelay:500, lengthMenu:[[50,100,-1],[50,100,"ALL"]], processing:!0, serverSide:!1, ajax:"", columns:[
            {
                data: "priority"
            },
            {
...
function search_adlink(title) {
 // $('#m_table_1').fadeOut("slow");
  ...
  else $('#m_table_1').DataTable().ajax.url("https://www.skearch.com/admin/categories/search_adlink/" + title).load();
