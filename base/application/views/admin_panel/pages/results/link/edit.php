            ...
            <form class="m-form m-form--fit m-form--label-align-right" method="POST">
              ...
              <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                  ...
                  <div class="col-7">
                    <input class="form-control m-input" type="text" name="title" value="<?php if (isset($result[0]->title)) echo $result[0]->title;
                ...
                <div class="form-group m-form__group row">
                  ...
                  <div class="col-7">
                    <input class="form-control m-input" type="text" name="description_short" value="<?php if (isset($result[0]->description_short)) echo $result[0]->description_short;
                ...
                <div class="form-group m-form__group row">
                  ...
                  <div class="col-7">
                    <input class="form-control m-input" type="text" name="display_url" value="<?php if (isset($result[0]->display_url)) echo $result[0]->display_url;
                                                                                              else if (form_error('display_url') == '') echo set_value('display_url'); ?>">
                  </div>
                </div>
                <div class="form-group m-form__group row">
                  <label for="example-text-input" class="col-2 col-form-label">URL</label>
                  <div class="col-7">
                    <input class="form-control m-input" type="text" name="www" value="<?php if (isset($result[0]->www)) echo $result[0]->www;
                                                                                      else if (form_error('www') == '') echo set_value('www'); ?>" required>
                  </div>
                </div>
                <div class="form-group m-form__group row">
                ...
                <div class="form-group m-form__group row">
                  ...
                  <div class="col-7">
                    <input type="hidden" name="enabled" value="0" <?php if (isset($result[0]->enabled) && $result[0]->enabled == 0) echo "checked";
                                                                  else echo set_checkbox('enabled', '0'); ?>>
                    <span class="m-switch m-switch--icon-check">
                      <label>
                        <input type="checkbox" name="enabled" value="1" <?php if (isset($result[0]->enabled) && $result[0]->enabled == 1) echo "checked";
                ...
                <div class="form-group m-form__group row">
                  ...
                  <div class="col-7">
                    <input type="hidden" name="redirect" value="0" <?php if (isset($result[0]->redirect) && $result[0]->redirect == 0) echo "checked";
                                                                    else echo set_checkbox('redirect', '0'); ?>>
                    <span class="m-switch m-switch--icon-check">
                      <label>
                        <input type="checkbox" name="redirect" value="1" <?php if (isset($result[0]->redirect) && $result[0]->redirect == 1) echo "checked";
                                                                          else echo set_checkbox('redirect', '1'); ?>>
                        <span></span>
                      </label>
                    </span>
                  </div>
