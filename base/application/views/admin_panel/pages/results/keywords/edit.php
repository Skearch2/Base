					...
					<div class="tab-pane active" id="m_user_profile_tab_1">
						<form class="m-form m-form--fit m-form--label-align-right" method="POST">
							...
							<div class="m-portlet__body">
								...
								<div class="form-group m-form__group row" id="umbrella-list" style=<?= $keyword_data->link_type == 'umbrella' ? 'display:block' : 'display:none' ?>>
								...
								<div class="form-group m-form__group row" id="field-list" style=<?= $keyword_data->link_type == 'field' ? 'display:block' : 'display:none' ?>>
									<label for="example-text-input" class="col-2 col-form-label"></label>
									<div class="col-7">
