						...
						<form class="m-form m-form--fit m-form--label-align-right" role="form" method="POST">
							...
							<div class="m-portlet__body">
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-7">
										<input class="form-control m-input" type="text" name="title" value="<?php if (isset($category[0]->title)) echo $category[0]->title;
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-7">
										<input class="form-control m-input" type="text" name="description" value="<?php if (isset($category[0]->description)) echo $category[0]->description;
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-7">
										<input class="form-control m-input" type="text" name="description_short" value="<?php if (isset($category[0]->description_short)) echo $category[0]->description_short;
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-7">
										<input class="form-control m-input" type="text" name="umbrella_name" value="<?php if (isset($category[0]->umbrella_name)) echo $category[0]->umbrella_name;
																													else if (form_error('umbrella_name') == '') echo set_value('umbrella_name'); ?>">
									</div>
								</div>
								<div class="form-group m-form__group row">
									<label for="example-text-input" class="col-2 col-form-label">Home Display Name</label>
									<div class="col-7">
										<input class="form-control m-input" type="text" name="home_display" value="<?php if (isset($category[0]->home_display)) echo $category[0]->home_display;
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-7">
										<input class="form-control m-input" type="text" name="keywords" value="<?php if (isset($category[0]->keywords)) echo $category[0]->keywords;
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-7">
										<input type="hidden" name="featured" value="0" <?php if (isset($category[0]->featured) && $category[0]->featured == 0) echo "checked";
																						else echo set_checkbox('featured', '0'); ?>>
										<span class="m-switch m-switch--icon-check">
											<label>
												<input type="checkbox" name="featured" value="1" <?php if (isset($category[0]->featured) && $category[0]->featured == 1) echo "checked";
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-7">
										<input type="hidden" name="enabled" value="0" <?php if (isset($category[0]->enabled) && $category[0]->enabled == 0) echo "checked";
																						else echo set_checkbox('enabled', '0'); ?>>
										<span class="m-switch m-switch--icon-check">
											<label>
												<input type="checkbox" name="enabled" value="1" <?php if (isset($category[0]->enabled) && $category[0]->enabled == 1) echo "checked";
