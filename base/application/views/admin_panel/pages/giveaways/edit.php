						...
						<form class="m-form m-form--state m-form--fit m-form--label-align-right" id="m_form" role="form" method="POST">
							...
							<div class="m-portlet__body">
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-lg-4 col-md-9 col-sm-12">
										<div class="input-group date">
											<input type="text" class="form-control m-input" readonly placeholder="Select date and time" id="m_datetimepicker" name="end_date" value="<?= set_value('end_date', $giveaway->end_date); ?>">
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-7">
										<input class="form-control m-input" type="text" name="amount" value="<?= set_value('amount', $giveaway->amount); ?>">
									</div>
								</div>
