 ...
 */
$config['tables']['users'] = 'skearch_users';
$config['tables']['groups'] = 'skearch_groups';
$config['tables']['users_groups'] = 'skearch_users_groups';
$config['tables']['login_attempts'] = 'skearch_login_attempts';
 ...
 */
$config['site_title'] = "Skearch"; // Site Title, example.com
$config['admin_email'] = "admin@skearch.com"; // Admin Email, admin@example.com
$config['default_group'] = 'Registered User'; // Default group, use name
...
$config['forgot_password_expiration'] = 172800; /* The number of seconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
