...
public function browse_field($umbrella_name, $field_name) {
        ...
        if (!$this->Category_model->get_category_id($umbrella_name)) {
          ...
          $umbrella_id = $this->Category_model->get_category_id($umbrella_name)->id;
      	   ...
      	   //should show related field than umbrella fileds in future work
          $data['fields'] = $this->Category_model->get_subcategories($umbrella_id, 20);

          $data['field_id'] = $field_id = $this->Category_model->get_subcategory_id($field_name)->id;
