 ...
 * @version		2.0
 */
class Brand_Direct extends MY_Controller
{
    ...
    {
        if (! file_exists(APPPATH.'/views/my_skearch/brand_direct/default.php')) {
            /*
        ...
        $data['title'] = ucwords("my skearch | brand direct");
        $data['page'] = 'brand direct';

        // Load page content
        $this->load->view('my_skearch/brand_direct/default', $data);
    }
}
