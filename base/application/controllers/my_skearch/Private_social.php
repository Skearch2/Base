 ...
 * @version		2.0
 */
class Private_Social extends MY_Controller {
	...
	public function index() {
	  ...
	  if ( ! file_exists(APPPATH.'/views/my_skearch/private_social/default.php')) {
		/*
    ...
    $data['page'] = 'private social';
		...
		// Load page content
		$this->load->view('my_skearch/private_social/default', $data);
	}
