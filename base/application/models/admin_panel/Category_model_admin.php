...
class Category_model_admin extends CI_Model {
  ...
  public function create_category($title, $enabled, $umbrella_name, $home_display, $description_short,
  $description, $keywords, $featured) {
      $data = array(
        'title' => $title,
        'enabled' => $enabled,
  ...
  public function create_subcategory($title, $enabled, $home_display, $description_short,
  $description, $keywords, $featured, $parent_id) {
      $data = array(
        'title' => $title,
        'enabled' => $enabled,
        'home_display' => $home_display,
  ...
  public function create_result_listing($title, $enabled, $description_short, $display_url, $www, $sub_id, $priority, $redirect) {
      ...
      $this->db->insert('skearch_listings', $data);
  }

  public function update_category($id, $title, $enabled, $umbrella_name, $home_display, $description_short,
  $description, $keywords, $featured) {
      $data = array(
        'title' => $title,
        'enabled' => $enabled,
  ...
  public function update_subcategory($id, $title, $enabled, $home_display, $description_short,
  $description, $keywords, $featured, $parent_id) {
      $data = array(
        'title' => $title,
        'enabled' => $enabled,
