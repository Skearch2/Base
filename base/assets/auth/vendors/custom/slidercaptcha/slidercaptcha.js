(function () {
    ...
    _proto.initImg = function () {
        ...
        var L = this.options.sliderL + this.options.sliderR * 2 + 3; // slider length
        ...
        img.onerror = function () {
            ...
            if (window.location.protocol === 'file:') {
                ...
                console.error("Unable to load the image file.");
            }
            if (loadCount >= that.options.maxLoadCount) {
                that.text.textContent = 'Failed to load the image.';
        ...
        img.setSrc = function () {
            ...
            if (isIE) { // IE browser cannot cross domain through img.crossOrigin, use ajax to get image blob and then convert it to dataURL to display
                ...
                xhr.onloadend = function (e) {
                    var file = new FileReader(); // FileReader supports IE10+ only
    ...
    _proto.verify = function () {
        var arr = this.trail; // moving distance of the y-axis when dragging
